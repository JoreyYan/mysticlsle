              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="mb-6">
                  <ImageUpload 
                    ...
                    folder="products"
                  />
                  <p className="text-[10px] text-gray-500 mt-2 text-center italic">Tip: You can select multiple files at once to speed up</p>
                </div>

                <div className="space-y-4 border-t pt-6">
                  <h3 className="text-xs font-bold uppercase text-gray-400 mb-2">Manage Images</h3>
